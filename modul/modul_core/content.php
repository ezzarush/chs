...
<!-- font CSS -->
<!-- font-awesome icons -->
<link href="<?=$app_path;?>assets/css/font-awesome.css" rel="stylesheet"> 
<!-- //font-awesome icons -->
 <!-- js-->
...
<link href="<?=$app_path;?>assets/css/custom.css" rel="stylesheet">
<!--//Metis Menu -->
</head> 
<body class="cbp-spmenu-push">
					...
					<ul class="nofitications-dropdown">
						<li class="dropdown head-dpdn">
							...
							<ul class="dropdown-menu">
								...
								<li><a href="#">
								   <div class="user_img"><img src="<?=$app_path;?>assets/images/1.png" alt=""></div>
								...
								<li class="odd"><a href="#">
									<div class="user_img"><img src="<?=$app_path;?>assets/images/2.png" alt=""></div>
								   <div class="notification_desc">
									<p>Lorem ipsum dolor amet </p>
									<p><span>1 hour ago</span></p>
									</div>
								...
								<li><a href="#">
								   <div class="user_img"><img src="<?=$app_path;?>assets/images/3.png" alt=""></div>
								   <div class="notification_desc">
									<p>Lorem ipsum dolor amet </p>
									<p><span>1 hour ago</span></p>
									</div>
						...
						<li class="dropdown profile_details_drop">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
								<div class="profile_img">	
									<span class="prfil-img"><img src="<?=$app_path;?>assets/images/a.png" alt=""> </span> 
									<div class="user-name">
										<p>Wikolia</p>
							...
							<ul class="dropdown-menu drp-mnu">
								...
								<li> <a href="<?=$app_path;?>modul/modul_core/logout.php"><i class="fa fa-sign-out"></i> Logout</a> 	
						 </li>
							</ul>
			...
			<div class="main-page">
				...
				<div class="row">
					<div class="col-md-8 map widget-shadow">
						...
						<!--map js-->
						<link href="<?=$app_path;?>assets/css/jqvmap.css" rel='stylesheet' type='text/css' />
						<script src="<?=$app_path;?>assets/js/jquery.vmap.js"></script>
						<script src="<?=$app_path;?>assets/js/jquery.vmap.sampledata.js" type="text/javascript"></script>
						<script src="<?=$app_path;?>assets/js/jquery.vmap.world.js" type="text/javascript"></script>
	...
	<!-- Classie -->
		<script src="<?=$app_path;?>assets/js/classie.js"></script>
		<script>
	...
	<!--scrolling js-->
	<script src="<?=$app_path;?>assets/js/jquery.nicescroll.js"></script>
	<script src="<?=$app_path;?>assets/js/scripts.js"></script>
	<!--//scrolling js-->
	<!-- Bootstrap Core JavaScript -->
   <script src="<?=$app_path;?>assets/js/bootstrap.js"> </script>
</body>
</html>